...
export class CreateFinancialActivityMappingComponent implements OnInit, OnDestroy {
   ...
   */
  constructor() {
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { financialActivityAccountsTemplate: any }) => {
