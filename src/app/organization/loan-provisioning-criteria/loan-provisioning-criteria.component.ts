...
export class LoanProvisioningCriteriaComponent implements OnInit, OnDestroy {
   ...
   */
  constructor() {
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { loanProvisioningCriterias: any }) => {
