...
export class EditCashierComponent implements OnInit, OnDestroy {
   ...
   */
  constructor() {
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { cashier: any; cashierTemplate: any }) => {
