...
export class ShareProductsComponent implements OnInit, AfterViewInit, OnDestroy {
   ...
   */
  constructor() {
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { shareProducts: any }) => {
