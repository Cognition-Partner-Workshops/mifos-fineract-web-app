...
export class ShareProductDatatableTabComponent implements OnDestroy {
  ...
  constructor() {
    ...
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { shareProductDatatable: any }) => {
