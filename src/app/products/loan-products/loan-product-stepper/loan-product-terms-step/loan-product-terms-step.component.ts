...
export class LoanProductTermsStepComponent implements OnInit, OnChanges, OnDestroy {
  ...
  setConditionalControls() {
    ...
    this.zeroInterest.valueChanges.pipe(takeUntil(this.destroy$)).subscribe((zeroInterest) => {
      if (zeroInterest) {
