...
export class RecurringDepositDatatableTabComponent implements OnDestroy {
  ...
  constructor() {
    ...
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { recurringDepositDatatable: any }) => {
