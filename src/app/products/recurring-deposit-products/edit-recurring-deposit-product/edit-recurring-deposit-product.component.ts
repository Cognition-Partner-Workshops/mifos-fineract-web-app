...
export class EditRecurringDepositProductComponent implements OnDestroy {
  ...
  constructor() {
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { recurringDepositProductAndTemplate: any }) => {
