...
export class CreateRecurringDepositProductComponent implements OnDestroy {
  ...
  constructor() {
    this.route.data.pipe(takeUntil(this.destroy$)).subscribe((data: { recurringDepositProductsTemplate: any }) => {
